                  ...
                  children: [
                    ...
                    SliderTheme(
                      data: SliderTheme.of(context).copyWith(
                          inactiveTickMarkColor: Color(0xF0A0E41),
                          activeTickMarkColor: Color(0xFA0A0E81),
                          thumbColor: Color(0xFD0A0E61),
                          overlayColor: Color(0xDF0A0E51),
                          thumbShape:
                      ...
                      cardChild: Column(
                        ...
                        children: [
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              MyRoundedButton(icon: Icons.remove,),
                              MyRoundedButton(icon: Icons.add,),
                    ...
                    child: ReusableCard(
                      ...
                      cardChild: Column(
                        ...
                        children: [
                          ...
                          Text('111', style: TextStyle(fontSize: 25),),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              MyRoundedButton(icon: Icons.remove,),
